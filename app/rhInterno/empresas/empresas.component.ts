...
@Component({
  ...
  styleUrls: ['./empresas.component.css','../../loadingArrows.css']
})
export class EmpresasComponent implements OnInit{
  ...
  constructor( private http: Http, private router: Router, private data: DataService, private route: ActivatedRoute){
	  this.columnDefs = [
      {headerName: 'Ctrl', field: 'id_empresa' },
  ...
  crearObra(){
    this.router.navigate(['recursosHumanos/empresas/crear-empresa']);
  }

  detalleObra(){ //Cambialo a detalleObra
    this.router.navigate(['recursosHumanos/empresas/empresa-detail/'+this.id]);
  }
