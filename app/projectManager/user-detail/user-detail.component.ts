...
export class UserDetailComponent implements OnInit {
  ...
  regresaUsuario(){
    this.router.navigate(['calidad/usuarios']);
  }


  mostrar(){

    window.alert("Solo el personal de RH puede modificar la información de un empleado.");
    /*
  ...
  subirFoto(){
    this.router.navigate(['calidad/insertar-foto/'+this.id]);
  }

  subirDoc(docNo: any ){
    this.router.navigate(['calidad/insertar-documento/'+this.id+'/'+docNo]);
  }
